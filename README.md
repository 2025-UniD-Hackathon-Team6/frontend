...
CarYou는 취업 준비 과정에서 겪는 번아웃, 방향성 부족, 정보 과잉 문제를 해결하기 위해 만든  
AI 기반 커리어 관리 플랫폼입니다.
...
### 2️⃣ 사용자 감정 기반 커리어 루틴 추천
- 스트레스 상태에 따라 학습 난이도 자동 조절  
- 프롬프트 엔지니어링 기반 맞춤 루틴 생성  
...
> 공공 API 문제를 해결하기 위해 DB 기반 필터링 시스템으로 개선
